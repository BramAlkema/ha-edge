...
echo ""
echo -e "${CYAN}═══ STEP 2: Google Home Developer Console ═══${NC}"
echo ""
echo "1. Go to: https://console.home.google.com"
echo "2. Create project → Select '${PROJECT_ID}'"
echo "3. Cloud-to-cloud → Create integration"
echo "4. Enter the fulfillment URL:"
echo ""
